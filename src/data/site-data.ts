...
export const RENTAL_EQUIPMENT: RentalEquipment[] = [
  { id: "r1", name: "HP LaserJet 72625", model: "HP-72625", brand: "HP", category: "office", description: "High-volume office laser printer with duplex printing and network support.", image: "/rentals/hp-72625.png", features: ["Auto Duplex", "Network Ready", "35 PPM", "1200 DPI"], dailyRate: 500, monthlyRate: 8000, corporateRate: "Custom", isAvailable: true, ppm: "35 PPM" },
  { id: "r2", name: "HP LaserJet 4104", model: "HP-4104", brand: "HP", category: "industrial", description: "Industrial-grade laser printer for heavy-duty printing needs.", image: "/rentals/hp-4104.png", features: ["45 PPM", "Heavy Duty", "Network", "Large Tray"], dailyRate: 800, monthlyRate: 15000, corporateRate: "Custom", isAvailable: true, ppm: "45 PPM" },
  { id: "r3", name: "Brother DCP-2541", model: "Brother-2541", brand: "Brother", category: "office", description: "Multi-function printer with print, scan, copy, and fax.", image: "/rentals/brother-2541.png", features: ["Print/Scan/Copy", "30 PPM", "ADF", "Wi-Fi"], dailyRate: 400, monthlyRate: 6000, corporateRate: "Custom", isAvailable: true, ppm: "30 PPM" },
  { id: "r4", name: "Scanner Cam C226", model: "Scanner Cam-C226", brand: "Canon", category: "office", description: "High-speed document scanner with ADF.", image: "/rentals/scanner-c226.png", features: ["ADF", "Duplex Scan", "Network", "Cloud Ready"], dailyRate: 600, monthlyRate: 10000, corporateRate: "Custom", isAvailable: true, ppm: "26 PPM" },
  { id: "r5", name: "HP LaserJet 1020", model: "HP-1020", brand: "HP", category: "laser", description: "Compact laser printer perfect for small offices.", image: "/rentals/hp-1020.png", features: ["Compact", "14 PPM", "USB", "Quiet"], dailyRate: 200, monthlyRate: 3000, corporateRate: "Custom", isAvailable: true, ppm: "14 PPM" },
  { id: "r6", name: "Riso RunF 160 PPM", model: "Riso-RunF-160", brand: "Riso", category: "industrial", description: "Ultra-high speed digital duplicator for mass production.", image: "/rentals/hp-72625.png", features: ["160 PPM", "Mass Production", "Low Cost", "A3 Support"], dailyRate: 2000, monthlyRate: 35000, corporateRate: "Custom", isAvailable: true, ppm: "160 PPM" },
];
