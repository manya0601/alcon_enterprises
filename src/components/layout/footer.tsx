      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            <Link href="/" className="flex items-center shrink-0 mb-4 h-16 overflow-visible">
              <img src="/logo.png" alt="Alcon Enterprise" className="w-auto h-full object-contain brightness-0 invert scale-125 md:scale-150 origin-left" />
            </Link>
